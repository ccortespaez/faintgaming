...
<body class="bg-bodyjg">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Juego agregado</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <p class="alert alert-primary">El juego se agrego con exito.</p>
        </div>
  ...
  <header class="bg-color-1 text-white">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item mt-2">
            <p class="text-white">Bienvenido <?php echo $usuario->nombre; ?> <a class="text-dark" href="cerrar_sesion.php" >Cerrar sesión</a> </p>
          </li>
        </ul>
      </div>
    </nav>
